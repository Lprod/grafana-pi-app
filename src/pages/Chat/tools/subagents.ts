...
- When live dashboard editing tools are available and the task is an on-the-fly edit to the currently open dashboard, prefer typed live tools such as rename_live_dashboard_panel, update_live_dashboard_panel_query, update_live_dashboard_panel_queries, apply_live_dashboard_prometheus_label_filter, add_live_dashboard_panel, move_or_resize_live_dashboard_panel, update_live_dashboard_settings, add_live_dashboard_variable, and update_live_dashboard_variable over Jsonnet dashboard save.
- Use apply_live_dashboard_prometheus_label_filter for dashboard-wide Prometheus variable filters and update_live_dashboard_panel_queries for known multi-panel expression replacements instead of repeated single-panel tool calls.
