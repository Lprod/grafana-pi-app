...
const child = spawn(process.execPath, ['scripts/benchmark-agent.mjs'], {
  ...
  env: {
    ...
    BENCH_LABEL: process.env.BENCH_LABEL ?? 'robust dashboard benchmark',
    BENCH_LOG_PREFIX: process.env.BENCH_LOG_PREFIX ?? 'robust-dashboard-benchmark',
    BENCH_TEST_FILE: process.env.BENCH_TEST_FILE ?? 'tests/agentRobustDashboardBenchmark.spec.ts',
